...
function EditLinkMenuContent({ editor, onCancel, onSave, labels, formatHref = links_1.formatHref, }) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (autoFocusOnTextInput) {
            (_a = textRef.current) === null || _a === void 0 ? void 0 : _a.focus({ preventScroll: true });
        }
        else {
            (_b = hrefRef.current) === null || _b === void 0 ? void 0 : _b.focus({ preventScroll: true });
        }
    ...
    return ((0, jsx_runtime_1.jsxs)("form", { onSubmit: (event) => {
        ...
        }, autoComplete: "off", children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h6", children: editMenuTitle }), (0, jsx_runtime_1.jsx)(material_1.TextField, { inputRef: textRef, value: textValue, disabled: isSubmitting, onChange: (event) => {
                    setTextValue(event.target.value);
                }, label: (_c = labels === null || labels === void 0 ? void 0 : labels.editLinkTextInputLabel) !== null && _c !== void 0 ? _c : "Text", margin: "normal", size: "small", fullWidth: true, required: true }), (0, jsx_runtime_1.jsx)(material_1.TextField, { inputRef: hrefRef, value: hrefValue, onChange: (event) => {
